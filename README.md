...
📝 Description
CampusClock is a student time tracking system designed specifically for educational institutions. It allows students to manually sign in using their student ID (no password required) and provides them with two simple options: Clock In and Clock Out. The system ensures integrity by enforcing the following:
...
Prevents falsified check-ins by enforcing geolocation and network verification.
...
Would you like a logo or sample UI mockup for your GitHub project too?
